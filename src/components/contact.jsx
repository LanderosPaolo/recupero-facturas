...
const ContactForm = () => {
    ...
    const handleFormSubmit = async (event) => {
        ...
        if (!name || !email || !company || !rut || !message) {
    ...
    <>
        <div className="container forms my-5" id='contact'>
            ...
            <form onSubmit={handleFormSubmit} action="https://formsubmit.co/af822a3c559564ee8fcc23aec60fc116" method="POST">
                ...
                <div className="form-group">
                    <label htmlFor="tel" className="form-label">Número de contacto</label>
                ...
                <div className="form-group">
                    ...
                    <input type="text" className="form-control" id="rut" name="rut" placeholder="Ingresa el RUT de la empresa" />
                </div>
                <div className="form-group">
